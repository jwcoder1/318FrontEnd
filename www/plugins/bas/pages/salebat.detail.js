define(function() {
    angular.module('app').controller('bas.salebat.detail',
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        scope.promise=utils.ajax({
                            method: 'DELETE',
                            url: "bas/salebat/" + scope.model.uid,
                            mockUrl: "plugins/data/salebat.detail.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.action.add();
                            scope.refreshtab("refreshsalebat", {});
