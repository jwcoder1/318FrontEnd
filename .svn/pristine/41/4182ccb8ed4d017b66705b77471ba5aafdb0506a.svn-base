...
interface HighchartsAxisTitle {
    ...
    style?: HighchartsCSSObject;
    /**
     * The actual text of the axis title. It can contain bas HTML text markup like <b>, <i> and spans with style.
...
interface HighchartsDataOptions {
     ...
     * sheet can be read from https://spreadsheets.google.com/feeds/worksheets/{key}/public/bas
     * @since 4.0
     */
...
interface HighchartsRendererObject {
    ...
    /**
     * Draw text. The text can contain a subset of HTML, like spans and anchors and some bas text styling of these.
