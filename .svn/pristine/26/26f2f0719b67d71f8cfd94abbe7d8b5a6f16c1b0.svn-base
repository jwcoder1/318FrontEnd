    ...
    angular.module('app').controller('acc.acccd',
        function($rootScope, $scope, $location, uiGridConstants, utils, path, settings,
            ...
            scope.data = [
                ...
                { cd_type: "1-1-1", pid: "1-1", cd_desc: "現金",eng_desc:"Cash",c_or_d:1,type_class:1 },
                { cd_type: "1-1-1-1", pid: "1-1-1", cd_desc: "零用金",eng_desc:"Petty cash",c_or_d:1,type_class:1 },
                { cd_type: "1-1-2", pid: "1-1", cd_desc: "銀行存款",eng_desc:"Bank savings",c_or_d:1,type_class:1 },
                { cd_type: "1-1-2-1", pid: "1-1-2", cd_desc: "銀行存款-一銀甲存",eng_desc:"Bank savingsA",c_or_d:1,type_class:1 },
                { cd_type: "1-1-2-2", pid: "1-1-2", cd_desc: "銀行存款-一銀乙存",eng_desc:"Bank savingsB",c_or_d:1,type_class:1 },
                { cd_type: "2", pid: "", cd_desc: "負債",eng_desc:"Debt",c_or_d:null,type_class:null },
                { cd_type: "3", pid: "", cd_desc: "業主權益",eng_desc:"Owners' rights",c_or_d:null,type_class:null },
