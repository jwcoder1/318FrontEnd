...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/cc42f09bd1dcb1f67af59d77e53e0b06b352fd67/ui-grid/ui-grid.d.ts
declare namespace uiGrid {
    ...
    export interface IGridInstanceOf<TEntity> {
         ...
         *
         * The bas logic flow makes use of the newRawData, oldRows and oldHash, and creates
         ...
         * instead, which is basally a debounced version of refresh.
         *
